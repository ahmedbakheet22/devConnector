...
router.delete('/:post_id',auth,async(req,res)=>{
    try {
        ...
        //check user has authority to delete the post
...
router.put('/like/:post_id',auth,async (req,res)=>{
    ...
    try {
        ...
        // check if the post is liked before
...
router.put('/unlike/:post_id',auth,async (req,res)=>{
    ...
    try {
        ...
        return  res.status(400).json({msg:'post is not then liked'})
        }
